function submitForm(){
    ...
    //&& 모두 필수 약관에 체크를 안해야지 필수 약관 동의해달라는 표기가 보임
    //|| 둘 중 하나라도 필수 약관에 체크를 하지 않았다면 모두 체크하라는 표기가 보여질 것
    // serviceChecked 가 false인 경우 느낌표를 붙이면 true로 변경해줌

    //serviceChecked = 서비스 항목에 체크를 안했을 때가 false인데 앞에 !붙여서 true로 변한 것
